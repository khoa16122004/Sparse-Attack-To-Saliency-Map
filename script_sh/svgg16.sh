...
# Example:
#   W_MARGIN=0.7 W_DEL=0.2 W_INS=0.1 sbatch svgg16.sh
...
# Example override:
#   FITNESSES="ce_margin_loss_saliency" sbatch svgg16.sh
#   FITNESSES="margin_loss_causal_faithfull ce_margin_loss_saliency" sbatch svgg16.sh
